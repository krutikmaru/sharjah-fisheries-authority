        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <p className="md:text-AE-Text-base text-AEBlack-800 dark:text-AEBlack-200">
              Member of the Executive Council, Chairman of the Sharjah Fish
              Resource Authority Authority. His responsibilities include
              developing and implementing local strategies and plans aimed at
              enhancing food and water security for the Emirate of Sharjah and
              preserving and sustaining the marine environment.
            </p>
