...
function VisionMission() {
  return (
    <div className="min-h-screen md:h-screen w-screen bg-white flex flex-col justify-center items-center space-x-0 space-y-4 md:space-x-4 md:space-y-0 py-20 px-10 lg:px-20 md:flex-row">
      <div className="w-full h-screen md:w-1/2 md:h-full p-10 rounded-md border-2 border-AEBlack-100 relative overflow-hidden flex flex-col items-start justify-start space-y-2">
        ...
        <svg
          ...
          fill="#000000"
          viewBox="0 0 256 256"
          className="absolute left-1/2 -translate-x-1/2 -bottom-32 w-[400px] z-10 fill-AEGold-300"
        >
